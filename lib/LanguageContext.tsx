...
const translations = {
  en: {
    ...
    about: {
      ...
      // New Presence/Location strings
      activeStatus: "ACTIVE",
      locationMain: "Worldwide",
      locationSub: "Global Node",
      netLabel: "NETWORK",
      netValue: "Distributed",
      accessLabel: "ACCESS",
      accessValue: "Remote-First",
      syncLabel: "SYNC",
      syncValue: "Auto-Scale",

      // New Connect strings
      secure: "SECURE CHANNEL",
      encrypted: "ENCRYPTED",
      connection: "Signal Locked",
      initialize: "Priority Access",
  ...
  ar: {
    ...
    about: {
      ...
      // New Presence/Location strings
      activeStatus: "نشط",
      locationMain: "حول العالم",
      locationSub: "نطاق عالمي",
      netLabel: "الشبكة",
      netValue: "موزع",
      accessLabel: "الوصول",
      accessValue: "عن بعد",
      ...
      secure: "قناة آمنة",
      encrypted: "مشفر",
      connection: "تم تأمين الإشارة",
      initialize: "وصول ذو أولوية",
    ...
    footer: {
      ...
      creativeMode: "الوضع الإبداعي: مفعل"
    },
    preloader: {
