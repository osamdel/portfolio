...
export const Hero: React.FC = () => {
  ...
  // Use translate3d for better GPU utilization on scroll
  ...
  return (
    <section id="hero" ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gray-50 pt-24 pb-12 sm:pt-20 sm:pb-0">
      ...
      <motion.div style={{ y: backgroundY }} className="absolute inset-0 w-full h-full pointer-events-none will-change-transform">
        {/* Grid Pattern */}
        ...
        <div className="absolute top-[-10%] left-[-10%] w-[80vw] sm:w-[50vw] h-[80vw] sm:h-[50vw] bg-purple-300/30 rounded-full mix-blend-multiply filter blur-[40px] sm:blur-[60px] animate-blob will-change-transform" />
        <div className="absolute top-[20%] right-[-10%] w-[80vw] sm:w-[50vw] h-[80vw] sm:h-[50vw] bg-indigo-300/30 rounded-full mix-blend-multiply filter blur-[40px] sm:blur-[60px] animate-blob animation-delay-2000 will-change-transform" />
        <div className="absolute bottom-[-20%] left-[20%] w-[90vw] sm:w-[60vw] h-[90vw] sm:h-[60vw] bg-blue-300/30 rounded-full mix-blend-multiply filter blur-[40px] sm:blur-[60px] animate-blob animation-delay-4000 will-change-transform" />
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full h-full flex flex-col justify-center min-h-[80vh]">
        <motion.div style={{ y: textY }} className="flex flex-col items-center text-center will-change-transform">
          ...
          <h1 className="text-[14vw] md:text-[11vw] leading-[0.85] md:leading-[0.8] font-extrabold tracking-tighter text-gray-950 uppercase flex flex-col items-center mb-6 sm:mb-8 select-none w-full">
             ...
             <div className="flex gap-[1vw] text-transparent bg-clip-text bg-gradient-to-b from-gray-300 to-gray-500 relative z-0 -mt-[1vw] md:-mt-[2vw] -mb-[1vw] md:-mb-[2vw]">
