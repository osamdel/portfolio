...
import { ArrowRight, Code2, Sparkles, Zap, User } from 'lucide-react';
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full flex flex-col items-center">
        ...
        >
          ...
          <div className="relative w-full max-w-4xl mx-auto h-[40vh] sm:h-[50vh] flex items-end justify-center mb-6 sm:mb-10">
             ...
             >
                {/* Main Personal Photo with Fallback and Error Handling */}
                <ImageWithFallback
                   src="/assets/main_photo.png" 
                   alt="Osama Adel"
                   className="h-full w-auto object-contain"
                   fallback={
                     <div className="h-full w-full flex items-center justify-center bg-gray-100 dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-white/10 p-10">
                        <div className="flex flex-col items-center gap-4 text-gray-400">
                           <User className="w-20 h-20 opacity-50" />
                           <span className="text-sm font-medium uppercase tracking-widest text-center">Add photo to<br/>/public/assets/main_photo.png</span>
                        </div>
                     </div>
                   }
                />
