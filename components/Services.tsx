  ...
  return (
    <section id="services" className="py-20 md:py-32 bg-gray-50 text-gray-900 scroll-mt-0 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
         ...
         <div className="absolute top-0 right-0 w-[500px] md:w-[1000px] h-[500px] md:h-[1000px] bg-indigo-100/50 rounded-full blur-[60px] md:blur-[100px] mix-blend-multiply" />
         <div className="absolute bottom-0 left-0 w-[500px] md:w-[1000px] h-[500px] md:h-[1000px] bg-blue-100/50 rounded-full blur-[60px] md:blur-[100px] mix-blend-multiply" />
