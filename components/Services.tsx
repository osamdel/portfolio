        ...
        <div className="mb-16 md:mb-24 flex flex-col xl:flex-row xl:items-end justify-between gap-12">
           <div className="max-w-4xl relative">
             ...
             >
                ...
                <div className="flex items-center gap-2 px-3 py-1 bg-indigo-50 dark:bg-indigo-900/30 rounded-full border border-indigo-100 dark:border-indigo-500/20">
                  ...
                  <span className="text-xs font-mono font-bold uppercase tracking-widest text-indigo-700 dark:text-indigo-300">Engineering Arsenal</span>
                </div>
             </motion.div>
             ...
             >
               Digital <br/>
               <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-blue-600 to-indigo-600 dark:from-indigo-400 dark:via-blue-400 dark:to-indigo-400 animate-shimmer bg-[length:200%_100%]">Capabilities</span>
             </motion.h2>
           </div>
           ...
           >
              <div className="group cursor-default">
                 ...
                 <p className="text-xs font-bold uppercase tracking-widest text-gray-500 dark:text-gray-400 group-hover:text-indigo-500 dark:group-hover:text-indigo-400 transition-colors">Core Disciplines</p>
              </div>
              ...
              <div className="group cursor-default">
                 ...
                 <p className="text-xs font-bold uppercase tracking-widest text-gray-500 dark:text-gray-400 group-hover:text-indigo-500 dark:group-hover:text-indigo-400 transition-colors">Technologies</p>
              </div>
           </motion.div>
        </div>
  ...
  return (
    <div className={cn(
      ...
      shadowColors[color]
       ...
       <div className="absolute top-0 right-0 w-full h-full opacity-[0.03] dark:opacity-[0.05] group-hover:opacity-100 transition-opacity duration-700 pointer-events-none mix-blend-multiply dark:mix-blend-screen">
          {graphic}
       </div>
...
// ... [Graphics components remain unchanged but ensure minimal expensive ops] ...
