             ...
             <ul className="space-y-4">
               {socialLinks.map((social) => (
                 <li key={social.name}>
                   ...
                   >
                     {social.name}
                     <ArrowUpRight className="w-5 h-5 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 rtl:translate-x-2 rtl:group-hover:translate-x-0 rtl:-rotate-90" />
                   </a>
                 </li>
               ))}
             </ul>
