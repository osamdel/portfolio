...
const TiltCard = ({ children, className, onClick }: TiltCardProps) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative group h-full w-full rounded-[2rem] bg-gray-900 border border-white/10 shadow-2xl transition-all duration-300 hover:border-indigo-500/30 cursor-default overflow-hidden",
        onClick && "cursor-pointer active:scale-98",
        className
      )}
    >
      <div style={{ transform: "translateZ(30px)" }} className="relative z-10 h-full pointer-events-none flex flex-col">
        {children}
      </div>
      ...
      <motion.div 
        style={{ 
          background: `radial-gradient(circle at ${glareX} ${glareY}, rgba(255,255,255,0.03) 0%, rgba(255,255,255,0) 50%)`,
...
// ... [ProfileCard, TechScannerCard, LocationCard, StatsCard, ConnectCard components are largely internal and fluid by default, 
// keeping them but ensuring they use flex/grid to fill space] ...
  ...
  return (
    <div className="h-full min-h-[300px] bg-gray-950 relative overflow-hidden flex flex-col justify-between p-6 sm:p-8 group">
      ...
      <div className="absolute inset-0 opacity-40 group-hover:opacity-60 transition-opacity duration-700">
         <div className="absolute top-[-50%] left-[-50%] w-[200%] h-[200%] bg-[conic-gradient(from_0deg,transparent_0_340deg,rgba(99,102,241,0.1)_360deg)] animate-[spin_10s_linear_infinite]" />
         <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-indigo-500/10 rounded-full blur-[80px]" />
         <div className="absolute bottom-0 left-0 w-[200px] h-[200px] bg-cyan-500/10 rounded-full blur-[60px]" />
      </div>
      ...
      <div className="relative z-10 flex justify-between items-start mb-6">
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-md">
           ...
           <span className="text-[10px] font-bold uppercase tracking-widest text-indigo-200">Neural Link Active</span>
        </div>
      ...
      <div className="relative z-10 my-auto group/text py-4">
         ...
         <div className="h-8 relative overflow-hidden flex items-center gap-3">
            <Scan className="w-4 h-4 text-indigo-400 mr-2 animate-pulse flex-shrink-0" />
         ...
         <div className="w-full p-4 rounded-xl bg-white/5 border border-white/10 backdrop-blur-md flex items-center justify-between gap-4 group/stats hover:bg-white/10 transition-colors duration-300">
            <div className="flex flex-col gap-1 w-1/3">
               <div className="flex items-center gap-1.5 text-gray-400">
                  ...
                  <span className="text-[9px] font-bold uppercase tracking-widest truncate">Commits</span>
               </div>
            ...
            <div className="flex flex-col gap-1 flex-1">
               <div className="flex justify-between items-center text-gray-400">
                  <div className="flex items-center gap-1.5">
                     ...
                     <span className="text-[9px] font-bold uppercase tracking-widest truncate">Capacity</span>
                  </div>
               ...
               <div className="flex gap-0.5 h-1.5 w-full items-end">
                  {[...Array(16)].map((_, i) => (
                     <div 
                       key={i} 
                       className={`flex-1 rounded-sm ${i > 12 ? 'bg-gray-700' : 'bg-indigo-500'} transition-all duration-300 group-hover/stats:bg-indigo-400`}
    ...
    <div className="h-full min-h-[400px] bg-gray-950 relative overflow-hidden rounded-[2rem] flex flex-col pointer-events-auto group">
      ...
      <div className="relative z-10 px-6 pt-6 flex justify-between items-center">
         <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-bold text-cyan-400 uppercase tracking-widest font-mono">System Schematic</span>
         </div>
      ...
      <div className="relative flex-1 flex flex-col justify-center items-center p-6 gap-6">
         ...
         <SchematicModule 
           ...
           bg="bg-indigo-950/30"
           skills={["Node.js", "Python", "GraphQL", "Redis"]}
         />
         <div className="h-8 w-px bg-gray-800 relative overflow-hidden flex-shrink-0">
         ...
         <SchematicModule 
           ...
           skills={["AWS", "Docker", "Postgres", "Vercel"]}
         />
      </div>
      ...
      <div className="relative z-10 px-6 pb-4 flex justify-between items-center border-t border-white/5 pt-3">
         <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-mono text-gray-400 uppercase">System Integrity: 100%</span>
         </div>
         <div className="flex gap-1">
            {[1,2,3,4].map(i => <div key={i} className="w-1 h-2 bg-gray-800 rounded-sm" />)}
         </div>
      </div>
    </div>
  );
...
const LocationCard = () => {
  return (
    <div className="h-full min-h-[280px] bg-gray-900 relative overflow-hidden rounded-[2rem] flex flex-col justify-between group">
       ...
       <div className="absolute -right-20 -top-20 w-64 h-64 opacity-20 transition-all duration-700 group-hover:opacity-40 group-hover:scale-110 pointer-events-none">
       ...
       <div className="relative z-10 p-6 h-full flex flex-col justify-between">
          <div className="flex justify-between items-start">
             ...
             <div className="flex items-center gap-1.5 px-2 py-1 rounded-full bg-cyan-950/50 border border-cyan-800/50">
                ...
                <span className="text-[10px] font-mono font-bold text-cyan-300">ONLINE</span>
             </div>
          </div>
    ...
    <div className="flex flex-col gap-1.5">
       <div className="flex justify-between items-end">
          ...
          <div className="flex items-baseline gap-1">
             ...
             <span className={`text-[10px] font-bold ${color} opacity-70 ml-1`}>{suffix}</span>
          </div>
       </div>
    ...
    <div className="h-full min-h-[280px] bg-gray-900 relative overflow-hidden rounded-[2rem] flex flex-col p-6 group">
      ...
      <div className="relative z-10 flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-bold text-purple-400 uppercase tracking-widest">Career Telemetry</span>
        </div>
        <div className="flex gap-1">
    ...
    >
      <div className="absolute inset-0 opacity-10 flex items-center justify-center gap-1 pointer-events-none">
        {[...Array(20)].map((_, i) => (
           <motion.div 
             ...
             className={`w-1 bg-indigo-500 rounded-full ${hovered ? 'bg-indigo-400 shadow-[0_0_5px_currentColor]' : 'bg-gray-800'}`}
             style={{ height: '10px' }}
           />
        ))}
      </div>
      ...
      <div className="flex justify-between items-start relative z-10">
        ...
        <div className={`px-2 py-1 rounded-md text-[10px] font-bold uppercase tracking-widest border transition-all duration-300 font-mono ${copied ? 'bg-green-500/20 border-green-500/50 text-green-400 shadow-[0_0_10px_rgba(34,197,94,0.3)]' : 'bg-white/5 border-white/10 text-gray-500'}`}>
          {copied ? 'UPLINK SECURE' : 'ENCRYPTED'}
        </div>
      </div>
      ...
      <div className="relative z-10 mt-4">
        <div className="flex items-center gap-2 mb-2">
           ...
           <h3 className="text-xl font-bold tracking-tight text-white group-hover:text-indigo-300 transition-colors">
             {copied ? 'Connection Open' : 'Initialize Uplink'}
           </h3>
        </div>
  ...
  return (
    <section id="about" className="py-20 md:py-32 bg-gray-950 scroll-mt-0 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-0 right-0 w-[400px] md:w-[600px] h-[400px] md:h-[600px] bg-indigo-900/10 rounded-full blur-[80px] md:blur-[120px]" />
        <div className="absolute bottom-0 left-0 w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-cyan-900/10 rounded-full blur-[80px] md:blur-[120px]" />
      </div>
        ...
        >
           <div>
              <div className="flex items-center gap-2 mb-4">
                 ...
                 <span className="text-sm font-bold uppercase tracking-widest text-gray-400">System Architecture</span>
              </div>
              <h2 className="text-4xl md:text-6xl font-bold text-white tracking-tighter">
                Beyond the Code
              </h2>
           </div>
           <p className="text-lg md:text-xl text-gray-400 max-w-lg leading-relaxed border-l-2 border-indigo-500/30 pl-6">
             Analyzing the operational metrics, core stack, and location data of the human behind the keyboard.
           </p>
        </motion.div>

        {/* Bento Grid - Responsive auto-rows */}
        <motion.div 
          ref={ref}
