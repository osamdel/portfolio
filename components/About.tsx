...
// ... [Keep ProfileCard, TechScannerCard, LocationCard, StatsCard, ConnectCard identical to previous version] ...
...
const LocationCard = () => {
  return (
    <div className="h-full min-h-[280px] bg-gray-900 relative overflow-hidden rounded-[2rem] flex flex-col justify-between group">
       ...
       <div className="absolute -right-20 -top-20 w-64 h-64 opacity-20 transition-all duration-700 group-hover:opacity-40 group-hover:scale-110 pointer-events-none will-change-transform">
