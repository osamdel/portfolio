...
import { Mail, ArrowUpRight, Send, Check, Loader2, Linkedin, Instagram } from 'lucide-react';
          ...
          <div className="lg:col-span-5 flex flex-col justify-between h-full gap-12">
            ...
            <div className="grid gap-4">
               ...
               <GlassInfoCard 
                 ...
                 label="LinkedIn" 
                 value="in/osamdel" 
                 href="https://www.linkedin.com/in/osamdel/" 
                 delay={0.4}
               />
               <GlassInfoCard 
                 icon={Instagram} 
                 label="Instagram" 
                 value="@osamdel" 
                 href="https://www.instagram.com/osamdel/" 
                 delay={0.5}
               />
            </div>
          </div>
