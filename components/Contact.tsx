  ...
  return (
    <section id="contact" ref={container} className="py-20 md:py-32 bg-gray-950 text-white relative overflow-hidden scroll-mt-0">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
         ...
         <motion.div style={{ y: useTransform(scrollYProgress, [0, 1], [50, -50]) }} className="absolute -bottom-[20%] -left-[10%] w-[400px] md:w-[800px] h-[400px] md:h-[800px] bg-purple-500/10 rounded-full mix-blend-screen filter blur-[80px] md:blur-[100px]" />
