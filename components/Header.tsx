  ...
  return (
    ...
    >
      <div className={cn(
        ...
        isScrolled 
          ? "bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl rounded-full border border-gray-200/50 dark:border-white/10 shadow-sm mx-3 sm:mx-8 lg:mx-auto py-2 pr-2 sm:pr-3" 
        ...
        {/* Right: CTA Button, Theme Toggle & Mobile Toggle */}
