...
export const Work: React.FC = () => {
  ...
  // Moving data here to use translations
  const projects = [
    {
      id: 1,
      title: "Art Bag",
      ...
      year: "2024",
      description: t.work.projects.artBag,
    ...
    },
    {
      ...
      year: "2024",
      description: t.work.projects.neonNexus,
    ...
    },
    {
      ...
      year: "2023",
      description: t.work.projects.travelAI,
    ...
    },
    {
      ...
      year: "2022",
      description: t.work.projects.creativeStudio,
    ...
    },
    {
      ...
      year: "2024",
      description: t.work.projects.finTechPro,
       ...
       <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 md:mb-20 gap-6 border-b border-gray-100 dark:border-gray-800 pb-8">
             <motion.div 
               ...
               viewport={{ once: true }}
             >
                <span className="text-sm font-bold uppercase tracking-widest text-indigo-600 dark:text-indigo-400 mb-2 block">{t.work.selectedWorks}</span>
                <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-gray-900 dark:text-white">{t.work.featuredProjects}</h2>
             </motion.div>
             ...
             >
                <p className="text-gray-500 dark:text-gray-400 text-sm max-w-xs text-right rtl:text-left">
                   {t.work.description}
                </p>
             </motion.div>
          </div>
          ...
          <div className="mt-16 text-center md:hidden">
              <a href="#contact" className="inline-flex items-center gap-2 text-sm font-bold uppercase tracking-widest text-gray-400 hover:text-indigo-600 transition-colors">
                {t.work.viewArchive} <ArrowUpRight className="w-4 h-4 rtl:-rotate-90" />
              </a>
          </div>
       </div>
    </section>
   ...
   return (
      ...
      >
         ...
         >
            ...
            <div className="absolute top-4 right-4 rtl:left-4 rtl:right-auto z-20 opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all duration-300">
                <div className="w-10 h-10 rounded-full bg-white dark:bg-gray-900 flex items-center justify-center shadow-lg">
                    <ArrowUpRight className="w-5 h-5 text-gray-900 dark:text-white rtl:-rotate-90" />
                </div>
            </div>
         </a>
